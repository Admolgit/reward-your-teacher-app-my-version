  ...
  return (
    <div className="flex items-center w-[100%] min-w-[400px] h-[80px] lg:min-w-[1000px] justify-between align-center sticky z-40 top-0 bg-[#fff] shadow-zinc-100 shadow-xl">
      ...
      <div className="flex justify-between w-[865px]  px-[4rem]">
        <div className="flex justify-center align-center m-auto relative"></div>
        <div className=" flex justify-center align-center ">
          <Link
            to="/students-dashboard/rewards-status"
            className="m-auto text-[#55a630] text-[24px] leading-[19.36px] font-[400] font-inter mx-3"
          >
            Rewards Status
          </Link>
          <img
