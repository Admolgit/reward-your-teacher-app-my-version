        ...
        <div
          ...
          className={`${
            hidden
              ...
              : 'text-lime-600 border-b-[5px] w-[50%]  border-slate-500'
          } w-[50%] text-center ml-[4rem]`}
        >
          Claimed Rewards
        </div>
        <div
          ...
          className={`${
            !hidden
              ? 'text-slate-600 text-center'
              : 'text-lime-600 border-b-[5px] border-slate-500 '
          ...
          {notifications
            ...
            .map(
              (
                ...
                <div key={idx}>
                  <h1 className="text-[17px] font-inter leading-[17px] font-[400] pt-[2rem] text-[#03435f]">
                    {x.title}
                  </h1>
